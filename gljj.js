 ...
 * Date: 2024-07-05
 * cron "0 7 * * *" gljj.js
 * export gljj= Authorization 多账号换行或者#分隔
 */
// ============================================================================================================
const $ = new Env('国乐酱酒') 
const axios = require('axios')
const env_name = 'gljj' //环境变量名字
...
async  userTask(user) {
    ...
    if (this.mist >= 7) {
        console.log(`账号[${user.index}] 签到天数大于等于7天,快去领酒🍺`);
    }
}
// =============================================================================================================================
//
    async  sign(user) {
        try {
            ...
            if (result?.code == 0) {
                //打印签到结果
                DoubleLog(`🕊账号[${user.index}] 签到成功：签到[${result.data.spanSumDays}]天🎉`);
