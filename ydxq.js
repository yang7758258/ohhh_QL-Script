...
!(async () => {
    await getNotice();
    await getVersion("yang7758258/ohhh154@main/ydxq.js");
    await main();
    await SendMsg(msg);
...
class run {
    constructor(user) {
        this.headers = {
            ...
            "Referer": "https://servicewechat.com/wxcb681732a25815c7/173/page-frame.html"
        }
...
//
    async  sign(user) {
        try {
            ...
            let urlObject = {
                method: 'post',
                url: `https://opmd.yadea.com.cn/api/miniprogram/custom-promotion/memberSign`,
