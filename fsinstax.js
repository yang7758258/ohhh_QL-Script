 ...
 *Author: Mist
 *Date: 2024-06-08
 *  vx富士instax玩拍由我俱乐部 Authorization uid=272458   这个url https://instax.app.xcxd.net.cn/api/user/272458/ 积分换实物
 * cron "10 8 * * *" fsinstax.js
 * export fsintax= uid&Authorization 多账号换行或者#分隔
 */
// ============================================================================================================
const $ = new Env('vx富士instax玩拍由我俱乐部') 
const axios = require('axios')
const env_name = 'fsinstax' //环境变量名字
